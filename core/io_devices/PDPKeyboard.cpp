...
uint16 PDPKeyboard::read_word(uint18 address, uint18 base_address) {
    ...
    switch (address) {
        case PDP_KEYBOARD_SYMBOL_MEMORY_ADDRESS:
            ...
            _buffer.erase(0, 1);
            return symbol;
        case PDP_KEYBOARD_ALT_FLAG_MEMORY_ADDRESS:return (uint16) (_ctrl_pressed ? 0000001 : 0000000);
        case PDP_KEYBOARD_SHIFT_FLAG_MEMORY_ADDRESS:return (uint16) (_ctrl_pressed ? 0000001 : 0000000);
        case PDP_KEYBOARD_CTRL_FLAG_MEMORY_ADDRESS:return (uint16) (_ctrl_pressed ? 0000001 : 0000000);
        default:throw new runtime_error("Wrong memory address PDPKeyboard");
    }
}
...
uint8 PDPKeyboard::read_byte(uint18 address, uint18 base_address) {
    ...
    switch (address) {
        ...
        case PDP_KEYBOARD_ALT_FLAG_MEMORY_ADDRESS + 1:return (uint8) (_ctrl_pressed ? 0001 : 0000);
        case PDP_KEYBOARD_SHIFT_FLAG_MEMORY_ADDRESS:
        case PDP_KEYBOARD_SHIFT_FLAG_MEMORY_ADDRESS + 1:return (uint8) (_ctrl_pressed ? 0001 : 0000);
        case PDP_KEYBOARD_CTRL_FLAG_MEMORY_ADDRESS:
        case PDP_KEYBOARD_CTRL_FLAG_MEMORY_ADDRESS + 1:return (uint8) (_ctrl_pressed ? 0001 : 0000);
        default:throw new runtime_error("Wrong memory address PDPKeyboard");
    }
}
