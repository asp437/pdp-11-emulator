/****************************************************************************
** Meta object code from reading C++ file 'cpustatetableview.h'
**
...
#error "The header file 'cpustatetableview.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_CPUStateTableView_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CPUStateTableView_t, stringdata0) + ofs \
