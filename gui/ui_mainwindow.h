...
public:
    ...
    void setupUi(QMainWindow *MainWindow) {
        ...
        memory_explorer_table->setObjectName(QStringLiteral("memory_explorer_table"));
            memory_explorer_table->setGeometry(QRect(0, 45, 490, 165));
